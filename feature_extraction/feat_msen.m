function [MsEn_features, MsEn_feature_labels]=feat_msen(x, options)
...
MsEn_feature_labels(1,:)=cellstr(strcat('msE_',split(num2str(1:num_mse_scales))));
MsEn_features=NaN(1, num_mse_scales);
...
[MsEn_features(1, :),~,info]=msentropy(x,[],[],[],[],[],[],[],num_mse_scales);
